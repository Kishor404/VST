...
class CurrentWorks extends StatefulWidget {
  ...
  @override
  State<CurrentWorks> createState() => _CurrentWorksState();
}

class _CurrentWorksState extends State<CurrentWorks> {
  ...
  Future<void> fetchCurrentWorks() async {
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => CurrentWork(service: service),
          ),
        );
      },
      child: Card(
